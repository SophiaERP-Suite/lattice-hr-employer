          ...
          <div className="row">
            <div className="col-xl-12">
              <div className="page-title-box d-flex-between flex-wrap gap-15">
                <h1 className="page-title fs-18 lh-1">Invoice Details</h1>
                <nav aria-label="breadcrumb">
                  <ol className="breadcrumb breadcrumb-example1 mb-0">
                    <li className="breadcrumb-item active" aria-current="page">
                      <NavLink to="/invoice-details">
                        Invoice Details
                        <svg
                  ...
                  <div className="card-body">
                    <div className="invoice-wrapper">
                      <div className="invoice-header">
                        <h1 className="fs-32 text-center mb-15">Invoice</h1>
                        ...
                        <div className="row gy-15">
                          ...
                          <div className="col-sm-6 col-12">
                            <div className="employee-info text-end text-xs-start">
                              ...
                              <p className="mb-5">
                                <strong>Issued Date:</strong> October 25, 2025
                              </p>
                              <p className="mb-5">
                                <strong>Due Date:</strong>November 2, 2025
                              </p>
                              <p>
