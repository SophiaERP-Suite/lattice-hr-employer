...
import {
  Clock, CheckCircle, XCircle, Filter, AlertCircle, FileText,
  CheckSquare, XSquare, Eye,
  CircleCheck,
  MoreVertical,
  CheckCheck,
  X,
...
import { approveLeave, getAllEmployeeLeaves, getAllLeaves, rejectLeave } from "../api/LeaveApi";
              ...
              <div className="card">
                <div className="card-body">
                  <div className="row g-3 align-items-center">
                    ...
                    <div className="col-md-2">
                      <NavLink className="btn btn-success w-100" to={"/workAndAttendance/Timesheet"}>
                ...
                <div className="modal-body">
                  <div className="d-flex align-items-center gap-3 mb-3">
                    <div className="avatar avatar-md">
                      <img
                        src={`${import.meta.env.VITE_API_URL}${selectedRequest.employeeAvatar}` || "/default-avatar.png"}
